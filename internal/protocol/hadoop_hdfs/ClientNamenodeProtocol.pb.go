...
var (
	file_ClientNamenodeProtocol_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
	file_ClientNamenodeProtocol_proto_msgTypes  = make([]protoimpl.MessageInfo, 170)
	file_ClientNamenodeProtocol_proto_goTypes   = []interface{}{
