...
// A ClientImpl represents a connection to an HDFS cluster
...
// suitable for creating a ClientImpl. Currently this sets the following fields
...
// NewClient returns a connected ClientImpl for the given options, or an error if
...
func NewClient(options ClientOptions) (Client, error) {
	...
	return &ClientImpl{namenode: namenode, options: options}, nil
}

// New returns ClientImpl connected to the namenode(s) specified by address, or an
...
func (c *ClientImpl) ReadFile(filename string) ([]byte, error) {
...
func (c *ClientImpl) CopyToLocal(src string, dst string) error {
...
func (c *ClientImpl) CopyToRemote(src string, dst string) error {
...
func (c *ClientImpl) fetchDefaults() (*hdfs.FsServerDefaultsProto, error) {
	if c.defaults != nil {
