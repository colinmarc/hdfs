...
func (c *SimpleClient) Mkdir(dirname string, perm os.FileMode) error {
...
func (c *SimpleClient) MkdirAll(dirname string, perm os.FileMode) error {
	return c.mkdir(dirname, perm, true)
}

func (c *SimpleClient) mkdir(dirname string, perm os.FileMode, createParent bool) error {
